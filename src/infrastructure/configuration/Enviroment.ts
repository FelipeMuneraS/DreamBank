export const dataBasePort: string = process.env.DATA_BASE_PORT || '';
export const dataBaseHost: string = process.env.DATA_BASE_HOST || '';
export const dataBaseName: string = process.env.DATA_BASE_NAME || '';
